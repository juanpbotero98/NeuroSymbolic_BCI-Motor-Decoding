...
from Models import GRU_RNN_StructPred
import nengo  
...
def main(gpu=False):
    ...
    model = GRU_RNN_StructPred(latent_size=latent_size)
    ...
    for phase, data_loader in data_loaders.items():
        ...
        accuracy, report, phase_pred, phase_labels = evaluate_struct_model(model,data_loader,device)
